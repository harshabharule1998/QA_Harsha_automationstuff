Feature: Tiffany state Controller Module for Category Manager CRUD feature
  ...
  @Regression
 Scenario: GET - Validate Category Manager can fetch state using countryId
	  ...
	  Given path '/countries/' + countryId + '/states'
		...
		@Regression
	Scenario: GET - Validate Category Manager can fetch specific state using stateId
