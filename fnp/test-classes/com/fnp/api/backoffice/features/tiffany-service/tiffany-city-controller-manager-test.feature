Feature: Tiffany city Controller Module for category Manager CRUD feature
  ...
  Background: 
   ...
   @Regression
	...
	Scenario: GET - Validate category Manager can not  fetch cities using Invalid cityId
	...
	Scenario: GET - Validate category Manager can fetch city using countryId
	...
	Scenario: GET - Validate category Manager can fetch city using stateId
