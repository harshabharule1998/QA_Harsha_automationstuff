Feature: Category Master history feature for Category Manager
  ...
  @Regression 
	# REV2-10743
	Scenario: GET - Validate Category Manager can fetch history for category after create
    ...
    * print "Filter Response : ", res
	...
	@Regression 
	# REV2-10744
	Scenario: GET - Validate Category Manager can fetch history for category after update
