Feature: Category Attribute history feature for Category Agent with Edit permission
  ...
  @Regression
	# REV2-10721
	Scenario: GET - Validate Category Agent with Edit permission can fetch attribute history for category after create
    ...
    * print "Filter Response : ", res
	...
	@Regression
	# REV2-10722
	Scenario: GET - Validate Category Agent with Edit permission can fetch attribute history for category after update
  ...
  @Regression
	# REV2-10723
	Scenario: GET - Validate Category Agent with Edit permission can fetch attribute history for category after delete
			
		# fetch category attribute history for deleted attribute
		
		* def deletedAttributeCategoryId = "9604258"
