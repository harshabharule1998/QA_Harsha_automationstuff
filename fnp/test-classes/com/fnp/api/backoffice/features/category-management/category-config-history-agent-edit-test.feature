Feature: Category Configuration history feature for Category Agent with Edit permission
    ...
    * header Authorization = authToken
	...
	@Regression
	# REV2-10582
	Scenario: GET - Validate Category Agent with Edit permission can fetch configuration history for category after create
    ...
    And param categoryId = result.responseData.id
  ...
  @Regression 
	# REV2-10583
	Scenario: GET - Validate Category Agent with Edit permission can fetch configuration history for category after update
