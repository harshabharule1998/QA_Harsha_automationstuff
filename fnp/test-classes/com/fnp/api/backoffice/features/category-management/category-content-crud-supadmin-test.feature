Feature: Category content crud scenarios for supeadmin
  ...
  #REV2-4209
  Scenario: POST- Validate request to create Category content for blankContentID
    ...
    * karate.log(requestPayload)
    ...
    And karate.log('Status : 201')
    And karate.log('Response is:', response)
    And match response.result.message == "Category content save successfully"
    And karate.log('Test Completed !')
  ...
  #REV2-4261
  Scenario: GET - Validate for valid category id
    * def result = call read('./category-content-crud-supadmin-test.feature@createCategoryContent')
    * def categoryId = result.categoryId
  ...
  Scenario: DELETE - Validate user can delete valid category content
    ...
    * def contentAssociationId = result.responseData.data
    ...
    #	And match response.message == 'Category content successfully.'
    And karate.log('Test Completed !')
