Feature: Category SEO Super Admin CRUD feature
  ...
  Background: 
    ...
    * def invalidCategoryId = '534cvv009'
	...
	# REV2-5600	
	Scenario: GET - Validate Super Admin cannot fetch SEO content for invalid categoryId 
	...
	@Regression
	# REV2-5663
	Scenario: PUT - Validate Super Admin can update SEO configuration for valid categoryId
    ...
    * eval requestPayload.canonical.url = canonicalUrl
	...
	# REV2-5665
	Scenario: PUT - Validate Super Admin cannot update SEO configuration for invalid categoryId
	...
	# REV2-5675
	Scenario: PUT - Validate Super Admin cannot update SEO configuration for blank categoryId
	...
	# REV2-5678
	Scenario: PUT - Validate Super Admin cannot update SEO configuration with blank values
