Feature: Category Simple Search feature for Category Manager
  ...
  # defectId : https://revvit2fnp.atlassian.net/browse/REV2-9226  
	#REV2-8041 
  Scenario: GET - Validate Category Manager to perform simple search with valid categoryId and valid contentId
  ...
  # defectId : https://revvit2fnp.atlassian.net/browse/REV2-9226
	#REV2-8042 
  Scenario: GET - Validate Category Manager to perform simple search with invalid categoryId and invalid contentId
    ...
    * header Authorization = authToken   
	...
	# defectId : https://revvit2fnp.atlassian.net/browse/REV2-9226
	#REV2-8043 
  Scenario: GET - Validate Category Manager to perform simple search with valid categoryId and valid contentName
  ...
  # defectId : https://revvit2fnp.atlassian.net/browse/REV2-9226  
	#REV2-8044 
  Scenario: GET - Validate Category Manager to perform simple search with invalid categoryId and invalid contentName
    ...
    * header Authorization = authToken   
	...
	#REV2-8059 
  Scenario: GET - Validate Category Manager to perform simple search with valid categoryId and valid attributeName
    ...
    * header Authorization = authToken   
	...
	#REV2-8060 
  Scenario: GET - Validate Category Manager to perform simple search with invalid categoryId and invalid attributeName
    ...
    * header Authorization = authToken   
	...
	#REV2-8061 
  Scenario: GET - Validate Category Manager to perform simple search with valid categoryId and valid attributeValue
    ...
    * header Authorization = authToken   
	...
	#REV2-8062 
  Scenario: GET - Validate Category Manager to perform simple search with invalid categoryId and invalid attributeValue
    ...
    * header Authorization = authToken   
	...
	#REV2-8077 
  Scenario: GET - Validate Category Manager to perform simple search with valid categoryId and valid categoryName
    ...
    * header Authorization = authToken   
	...
	# defectId : https://revvit2fnp.atlassian.net/browse/REV2-9438 
	#REV2-8078 
  Scenario: GET - Validate Category Manager to perform simple search with invalid categoryId and invalid categoryName
    ...
    * header Authorization = authToken   
	...
	# defectId : https://revvit2fnp.atlassian.net/browse/REV2-9438
	#REV2-8079 
  Scenario: GET - Validate Category Manager to perform simple search with valid categoryId and valid associationId
  ...
  # defectId : https://revvit2fnp.atlassian.net/browse/REV2-9438 
	#REV2-8080 
  Scenario: GET - Validate Category Manager to perform simple search with invalid categoryId and invalid associationId
