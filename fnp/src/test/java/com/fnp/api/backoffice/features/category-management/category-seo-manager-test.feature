Feature: Category SEO Category Manager CRUD feature
  ...
  Background: 
    ...
    * def invalidCategoryId = '534cvv009'
	...
	# REV2-5602	
	Scenario: GET - Validate Category Manager cannot fetch SEO content for invalid categoryId 
	...
	@Regression
	# REV2-5666
	Scenario: PUT - Validate Category Manager can update SEO configuration for valid categoryId
    ...
    * eval requestPayload.canonical.url = canonicalUrl
	...
	# REV2-5668
	Scenario: PUT - Validate Category Manager cannot update SEO configuration for invalid categoryId
	...
	# REV2-5676
	Scenario: PUT - Validate Category Manager cannot update SEO configuration for blank categoryId
	...
	# REV2-5679
	Scenario: PUT - Validate Category Manager cannot update SEO configuration with blank values
