Feature: Category Attribute history feature for Category Manager
  ...
  @Regression
	# REV2-10718
	Scenario: GET - Validate Category Manager can fetch attribute history for category after create
    ...
    * print "Filter Response : ", res
	...
	@Regression
	# REV2-10719
	Scenario: GET - Validate Category Manager can fetch attribute history for category after update
  ...
  @Regression
	# REV2-10720
	Scenario: GET - Validate Category Manager can fetch attribute history for category after delete
