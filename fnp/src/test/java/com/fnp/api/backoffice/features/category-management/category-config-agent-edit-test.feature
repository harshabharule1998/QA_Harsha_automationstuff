Feature: Category Configuration Category Agent with edit permission CRUD feature
  ...
  @Regression
	# REV2-4276	
	Scenario: GET - Validate Category Agent with edit permission can fetch category configuration details for valid categoryId
	...
	# REV2-4280	
	Scenario: GET - Validate error message for Category Agent with edit permission to fetch category configuration details for invalid categoryId
	...
	# REV2-4284
	Scenario: GET - Validate error message for Category Agent with edit permission to fetch category configuration details for blank categoryId
  ...
  @Regression
	# REV2-4318	
	Scenario: PATCH - Validate Category Agent with edit permission can update category configuration for valid categoryId with propagationChildCategories not mentioned  
    ...
    * karate.log(requestPayload)
	...
	# REV2-4319
	Scenario: PATCH - Validate error message for Category Agent with edit permission to update category configuration with invalid categoryId    
    ...
    * karate.log(requestPayload)
	...
	# REV2-4320
	Scenario: PATCH - Validate error message for Category Agent with edit permission to update category configuration with blank categoryId    
  ...
  @Regression
	# REV2-4322	
	Scenario: PATCH - Validate Category Agent with edit permission can update category configuration for valid categoryId with propagationChildCategories mentioned  
    ...
    * karate.log(requestPayload)
	...
	# REV2-4321	
	Scenario: PATCH - Validate Category Agent with edit permission can update category configuration for valid categoryId with invalid propagationChildCategories  
