Feature: Tag Advance Search feature for Super Admin
  ...
  @Regression
  #REV2-5769 
  Scenario: GET - Validate Super Admin can perform advance search for Tag with EqualTo operator
  ...
  #REV2-5770 
  Scenario: GET - Validate Super Admin can perform advance search for Tag with NotEqualTo operator
  ...
  @Regression
  #REV2-5771 
  Scenario: GET - Validate Super Admin can perform advance search for Tag with Like operator
  ...
  #REV2-5772 
  Scenario: GET - Validate Super Admin can perform advance search for Tag with NotLike operator
  ...
  #REV2-5773 
  Scenario: GET - Validate Super Admin can perform advance search for Tag with In operator
  ...
  #REV2-5774 
  Scenario: GET - Validate Super Admin can perform advance search for Tag with NotIn operator
    ...
    * def encodedText = encode(searchRequestString)
	...
	#REV2-5776 
  Scenario: GET - Validate Super Admin cannot perform advance search for Tag with only optional parameters
    ...
    * def encodedText = encode(searchRequestString)
	...
	#REV2-5777 
  Scenario: GET - Validate Super Admin cannot perform advance search for Tag with all blank parameters
    ...
    * def encodedText = encode(searchRequestString)
	...
	#REV2-5778 
  Scenario: GET - Validate Super Admin cannot perform advance search for Tag with all invalid values in parameters
    ...
    * def encodedText = encode(searchRequestString)
	...
	#REV2-5779
	Scenario: GET - Validate Super Admin can perform advance search for Tag having spacing in parameter values
