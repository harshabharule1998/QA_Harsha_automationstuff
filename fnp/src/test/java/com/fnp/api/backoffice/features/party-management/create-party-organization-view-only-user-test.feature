Feature: Create new party organization API for view only user
    ...
    * def requestPayload = read('classpath:com/fnp/api/backoffice/data/party/create-party-organization.json')
	...
	#REV2-21449
  Scenario: POST - Validate Party View Only user can create party organization for valid values
